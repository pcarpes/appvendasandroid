from butoes import ImageButton, LabelButton
...
class BannerVendedor(FloatLayout):
    def __init__(self, **kwargs):
        ...
        link = f'https://aplicativovendashash-e2261-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        images = ImageButton(source=f"icones/fotos_perfil/{avatar}", pos_hint={"right":0.4, "top":0.9}, size_hint=(0.3, 0.8),
